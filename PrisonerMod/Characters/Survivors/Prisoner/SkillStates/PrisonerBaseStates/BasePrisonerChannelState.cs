...
namespace PrisonerMod.Characters.Survivors.Prisoner.SkillStates.PrisonerBaseStates
{
    internal class BasePrisonerChannelState : BaseSkillState
    {
        ...
        public string muzzleString = "HandL";
        ...
        public override void OnEnter()
        {
            ...
            if (this.muzzleString == "HandL")
            {
                ChildLocator childLocator = base.GetModelChildLocator();
                if (childLocator)
                {
                    GameObject castEffect = childLocator.FindChild("HandL").gameObject;
