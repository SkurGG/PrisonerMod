...
{
    public class ChargeHollow : BasePrisonerSkillState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            {
                this.outer.SetNextState(new ThrowHollow { charge = num });
            }
        }
        ...
        public GameObject chargeEffectPrefab = PrisonerAssets.hollowPurpleProjectilePrefab;
